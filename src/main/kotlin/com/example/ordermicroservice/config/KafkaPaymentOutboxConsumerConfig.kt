...
class KafkaPaymentOutboxConsumerConfig {
    ...
    fun paymentOutboxConsumerFactory(): ConsumerFactory<String, PaymentOutboxMessage> {
        ...
        config[KafkaAvroDeserializerConfig.SPECIFIC_AVRO_VALUE_TYPE_CONFIG] = PaymentOutboxMessage::class.java.name
    ...
    fun paymentOutboxListenerContainer(): ConcurrentKafkaListenerContainerFactory<String, PaymentOutboxMessage> {
        val listener = ConcurrentKafkaListenerContainerFactory<String, PaymentOutboxMessage>()
        listener.consumerFactory = paymentOutboxConsumerFactory()
