...
class KafkaShippingConsumerConfig {
    @Bean
    fun shippingConsumerFactory(): ConsumerFactory<String, ShippingMessage> {
        val config = mutableMapOf<String, Any>()
        config[ConsumerConfig.GROUP_ID_CONFIG] = "SHIPPING"
        ...
        config[KafkaAvroDeserializerConfig.SPECIFIC_AVRO_VALUE_TYPE_CONFIG] = ShippingMessage::class.java.name
    ...
    fun shippingListenerContainer(): ConcurrentKafkaListenerContainerFactory<String, ShippingMessage> {
        ...
        listener.consumerFactory = shippingConsumerFactory()
